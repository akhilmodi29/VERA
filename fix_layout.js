...
const NavItem: React.FC<NavItemProps> = ({ to, icon, label, exact }) => (
  <NavLink
    ...
    className={({ isActive }) =>
      \lex items-center px-4 py-3 rounded-lg transition-all duration-300 \\
    }
  >
    {icon}
...
fs.writeFileSync('frontend/src/layouts/MainLayout.tsx', mainLayout);
console.log("MainLayout generated.");
